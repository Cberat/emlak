          ...
          <div class="row mb-5">
            <div class="col-md-6">
              <div class="media media-custom d-block mb-4">
                <a href="blog-single.html" class="mb-4 d-block"><img src="{{asset("assets/frontend/img/img_1.jpg")}}" alt="Image placeholder" class="img-fluid"></a>
            ...
            <div class="col-md-6">
               <div class="media media-custom d-block mb-4">
                <a href="blog-single.html" class="mb-4 d-block"><img src="{{asset("assets/frontend/img/img_2.jpg")}}" alt="Image placeholder" class="img-fluid"></a>
                <div class="media-body">
                  <span class="meta-post">February 26, 2018</span>
                ...
                <ul class="post-list list-unstyled">
                  <li>
                    <a href="blog-single.html" class="d-flex">
                      <span class="mr-3 image"><img src="{{asset("assets/frontend/img/img_1.jpg")}}" alt="Image placeholder" class="img-fluid"></span>
                      <div>
                  ...
                  <li>
                    <a href="blog-single.html" class="d-flex">
                      <span class="mr-3 image"><img src="{{asset("assets/frontend/img/img_2.jpg")}}" alt="Image placeholder" class="img-fluid"></span>
                      <div>
                        <span class="meta">February 27, 2018</span>
                        <h3>Five Reasons to Stay at Villa Resort</h3>
                      </div>
                  ...
                  <li>
                    <a href="blog-single.html" class="d-flex">
                      <span class="mr-3 image"><img src="{{asset("assets/frontend/img/img_3.jpg")}}" alt="Image placeholder" class="img-fluid"></span>
                      <div>
                        <span class="meta">February 27, 2018</span>
                        <h3>Five Reasons to Stay at Villa Resort</h3>
                      </div>
